...
<template>
    ...
    <AuthenticatedLayout>
        <template #header>
            ...
            <a v-if="$page.props.auth.user.id == 1" :href="route('channel.crear', { id: $page.props.auth.user.id })"><button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Crear</button></a>
        </template>
